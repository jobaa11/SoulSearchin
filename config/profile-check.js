...
`profiles/instructors/${allUsers._id}`,`profiles/students/${allUsers._id}`,`profiles/instructor/${allUsers._id}`,`profiles/student/${allUsers._id}`, `profiles/${allUsers._id}`, `profiles/${allUsers._id}/edit`, 'profiles/instructor'];
